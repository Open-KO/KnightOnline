...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT /*lpcs*/, CCreateContext *pContext)
{
    ...
    //	if (!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CN3ViewerView), CSize(rc.Width() - nW1, rc.Height()),
    //pContext) || 		!m_wndSplitterLeft.CreateView(0, 0, RUNTIME_CLASS(CViewSceneTree), CSize(nW1, rc.Height()/2),
    //pContext) || 		!m_wndSplitterLeft.CreateView(1, 0, RUNTIME_CLASS(CViewProperty), CSize(nW1, rc.Height()/2),
    //pContext) )
    //	{
