...
CDlgEditEvent::CDlgEditEvent(CWnd* pParent /*=nullptr*/) : CDialog(CDlgEditEvent::IDD, pParent)
{
...
void CDlgEditEvent::ResetAll()
{
	...
	for (itEvent = m_pRefEventMgr->m_pEvents.begin(); itEvent != m_pRefEventMgr->m_pEvents.end();
		itEvent++)
	{
