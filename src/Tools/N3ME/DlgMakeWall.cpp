...
CDlgMakeWall::CDlgMakeWall(CWnd* pParent /*=nullptr*/) : CDialog(CDlgMakeWall::IDD, pParent)
{
...
void CDlgMakeWall::ResetAll()
{
	...
	for (itWall = m_pRefWallMgr->m_pWalls.begin(); itWall != m_pRefWallMgr->m_pWalls.end();
		itWall++)
	{
