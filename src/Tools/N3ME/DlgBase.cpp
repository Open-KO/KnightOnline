...
CDlgBase::CDlgBase(CMapMng* pMapMng, CWnd* pParent /*=nullptr*/) : CDialog(CDlgBase::IDD, pParent)
{
...
void CDlgBase::UpdateInfo()
{
	...
	if (pBase->Type() & OBJ_CHARACTER)
	{
		...
		m_CBChrLOD.SetWindowPos(
			nullptr, pt.x + 3 + rc.Width(), pt.y, rc.Width() - 3, rc2.Height(), SWP_NOZORDER);
