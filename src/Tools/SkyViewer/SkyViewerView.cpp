...
void CSkyViewerView::OnDraw(CDC* pDC)
{
	...
	{
		pFrm->m_Lights[i].m_Data.Diffuse = _D3DCOLOR_To_D3DCOLORVALUE(
			pDoc->m_Sky.GetLightDiffuseColor(i));
		pFrm->m_Lights[i].m_Data.Ambient = _D3DCOLOR_To_D3DCOLORVALUE(
			pDoc->m_Sky.GetLightAmbientColor(i));
