...
_POINT	_Convert3D_To_2DCoordinate(const __Vector3& vPos, const __Matrix44& mtxView, const __Matrix44& mtxProjection, int iViewportWidth, int iViewportHeight);
void	_Convert2D_To_3DCoordinate(int ixScreen, int iyScreen, const __Matrix44& mtxView, const __Matrix44& mtxPrj, int iViewportWidth, int iViewportHeight, __Vector3& vPosResult, __Vector3& vDirResult);
