...
public:
	...
	{
		return m_vScale;
	} // Rotation 은 LookAt Position 처럼, Scale 은 UpVector 처럼 쓴다..
	__Vector3 Dir()
	{
	...
	void EyePosSet(const __Vector3& v)
	{
		m_vPos = v;
	}
	void EyePosSet(float x, float y, float z)
	{
		m_vPos.Set(x, y, z);
	}
	void AtPosSet(const __Vector3& v)
	{
		m_vAt = v;
	}
	void AtPosSet(float x, float y, float z)
	{
		m_vAt.Set(x, y, z);
	}
	void UpVectorSet(const __Vector3& v)
	{
		m_vScale = v;
	} // Scale 은 UpVector 처럼 쓴다..
	void UpVectorSet(float x, float y, float z)
	{
		m_vScale.Set(x, y, z);
	} // Scale 은 UpVector 처럼 쓴다..
