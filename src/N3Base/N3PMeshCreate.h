...
protected:
	...
	void TryEdge(int pt_a, int pt_b, float& be_val, uint16_t& be_a, uint16_t& be_b, bool& IsOver);
...
protected:
	...
	void SwapToEnd(uint16_t swapper, __PMCEdgeCollapse* collapses, __PMCEdgeCollapse* collapses_end,
		uint16_t& pt_to, uint16_t& pt_from);
