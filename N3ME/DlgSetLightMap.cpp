...
CDlgSetLightMap::CDlgSetLightMap(CWnd *pParent /*=nullptr*/) : CDialog(CDlgSetLightMap::IDD, pParent)
{
...
DWORD CDlgSetLightMap::GetColor()
{
    ...
    //	DWORD Color = SrcColor + (SrcColor<<4) + (SrcColor<<8) + (SrcColor<<12) + (SrcColor<<16) + (SrcColor<<20) +
    //(SrcColor<<24) + (SrcColor<<28); 	return Color;
}
