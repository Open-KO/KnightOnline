...
CTransDummy::CTransDummy()
{
    ...
    InitDummyCube(
        DUMMY_CENTER, &(m_DummyCubes[DUMMY_CENTER]), __Vector3(0, 0, 0), D3DCOLOR_ARGB(0xff, 0xff, 0xff, 0x00));
    InitDummyCube(
        DUMMY_X, &(m_DummyCubes[DUMMY_X]), __Vector3(fCubeOffset, 0, 0), D3DCOLOR_ARGB(0xff, 0xff, 0x00, 0x00));
    InitDummyCube(
        DUMMY_Y, &(m_DummyCubes[DUMMY_Y]), __Vector3(0, fCubeOffset, 0), D3DCOLOR_ARGB(0xff, 0x00, 0xff, 0x00));
    InitDummyCube(
        DUMMY_Z, &(m_DummyCubes[DUMMY_Z]), __Vector3(0, 0, fCubeOffset), D3DCOLOR_ARGB(0xff, 0x00, 0x00, 0xff));
