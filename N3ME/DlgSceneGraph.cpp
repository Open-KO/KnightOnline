...
CDlgSceneGraph::CDlgSceneGraph(CWnd *pParent /*=nullptr*/, DWORD dwFlag) : CDialog(CDlgSceneGraph::IDD, pParent)
{
...
void CDlgSceneGraph::UpdateTreeItem(HTREEITEM hParent, CN3Base *pBase)
{
    ...
    HTREEITEM hItem = m_Tree.InsertItem(
        TVIF_IMAGE | TVIF_SELECTEDIMAGE | TVIF_TEXT, pBase->m_szName.c_str(), nItem, nItem, 0, 0, 0, hParent, nullptr);
