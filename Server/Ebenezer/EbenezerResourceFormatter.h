...
template <typename... Args> inline std::string format_db_resource(uint32_t resourceId, Args &&...args)
{
    std::string fmtStr;
    ...
    {
        spdlog::error("format_db_resource({}) failed - invalid args for format string.", resourceId);
    }
