...
enum e_LogicCheck
{
	...
	LOGIC_NOEXIST_ITEM				= 0x05,
	LOGIC_CHECK_CLASS				= 0x06,
	LOGIC_CHECK_WEIGHT				= 0x07,
	LOGIC_CHECK_EDITBOX				= 0x08,
	LOGIC_RAND						= 0x09,
	LOGIC_HOWMUCH_ITEM				= 0x0A,
	LOGIC_CHECK_LEVEL				= 0x0B,
	LOGIC_NOEXIST_COM_EVENT			= 0x0C,
	LOGIC_EXIST_COM_EVENT			= 0x0D,
	LOGIC_CHECK_NOAH				= 0x0E
};
