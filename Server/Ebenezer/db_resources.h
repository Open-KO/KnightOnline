...
enum e_DBResourceID
{
    ...
    // It's technically *also* triggered in our code, but it's way before we even establish a connection to the DB
    // server. Officially it uses the MFC resource. IDP_SOCKETS_INIT_FAILED							= 103, // Failed
    ...
    IDP_KNIGHT_INSUFFICIENT_SKILL =
        114, // You need to have at least 10 Leadership skill points and 5 Manner skill points in order to create a
    IDP_KNIGHT_INSUFFICIENT_CHARISMA =
        115, // You need to have at least 120 Attractactiveness skill points in order to create a Knights
    ...
    IDS_BANISH_USER =
        132, // Users in the Lunar Valley and the enemy’s territory will be teleported back to their own Nations.
    ...
    IDS_KILL_KARUS_GUARD1 =
        136, // The sentry at the 1st Karus fortress has been killed. The user that killed the sentry is [%s][%s]
    IDS_KILL_KARUS_GUARD2 =
        137, // The sentry at the 2nd Karus fortress has been killed. The user that killed the sentry is [%s][%s]
    IDS_KILL_ELMO_GUARD1 =
        138, // The sentry at the 1st El Morad fortress has been killed. The user that killed the sentry is [%s][%s]
    IDS_KILL_ELMO_GUARD2 =
        139, // The sentry at the 2nd El Morad fortress has been killed. The user that killed the sentry is [%s][%s]
    ...
    IDS_SNOWBATTLE_BANISH_USER =
        158,                     // The users in the Snow Fight Zone will be teleported back to their native country.
    IDS_BATTLEZONE_STATUS = 159, // Number of killed Karus users : %d, Number of killed El Morad users : %d
    IDS_BANISH_LOSER =
        160, // The users of the defeated nation in Lunar Valley will be teleported back to their native country.
    ...
    IDS_SIEGE_WAR_READY_TIME =
        169, // Castle Siege War is about to begin. The designated Knights should enter the Castle Siege War zone.
    ...
    IDS_SIEGE_WAR_READY_TIME_NOTICE =
        173, // There are %d minutes remaining until the Castle Siege War. Knights should enter the CSW now.
    IDS_CHALLENGER_REQUEST_START_NOTICE =
        174, // We are currently accepting challengers for Castle Siege War. Location Moradon : 351,400
    IDS_CHALLENGER_REQUEST_END_NOTICE = 175, // The registration period for Castle Siege War has now ended.
    IDS_SIEGE_WAR_GUIDON_TIME_NOTICE =
        176, // There are %d minutes remaining for building your base. If you don't build a base by then, you'll aut
    ...
    IDS_MONEY_REPAY_EVENT =
        187, // Coin event has started. You will earn an additional %d percent of coins for killing mobs.
    ...
    IDS_EXP_REPAY_EVENT =
        197, // Experience point event Started. You will Earn %d Percent of Experience for killing Mobs.
    ...
    IDS_MONSTER_CHALLENGE_VICTORY =
        201, // You have eliminated all the monsters in the temple. You've received the treasure chest.
    IDS_MONSTER_CHALLENGE_CLOSE =
        202, // Forgotten Temple is now over. Users remaining in the Forgotten Temple zone will be Teleported out.
    ...
    IDS_KING_KARUS_NOAH_BONUS_EVENT =
        221, // The Karus King has initiated the %d (percent) increased item drop rate event.
    IDS_KING_KARUS_EXP_BONUS_EVENT =
        222, // The Karus King has initiated the %d (percent) increased experience point event.
    IDS_KING_ELMO_NOAH_BONUS_EVENT =
        223, // The El Morad King has initiated the %d (percent) increased item drop rate event.
    IDS_KING_ELMO_EXP_BONUS_EVENT =
        224, // The El Morad King has initiated the %d (percent) increased experience point event.
    ...
    IDS_KING_PERIOD_OF_RECOMMEND_MESSAGE =
        227, // This is a period for nominating a King. Users with nomination rights should nominate a King.
    IDS_KING_PERIOD_OF_ELECTION_MESSAGE =
        228, // King election period is on. Users that have not voted yet should vote for a King.
    ...
    IDS_BEEF_ROAST_VICTORY_ELMORAD =
        240,                     // The El Morad warriors have destroyed the monument and can now enter Bifrost!
