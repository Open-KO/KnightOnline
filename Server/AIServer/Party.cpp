...
void CParty::PartyCreate(char *pBuf)
{
    ...
    {
        spdlog::error(
            "Party::PartyCreate: failed [partyId={} uid0={} uid1={}]", sPartyIndex, pParty->uid[0], pParty->uid[1]);
        delete pParty;
        return;
    }

    spdlog::debug(
        "Party::PartyCreate: success [partyId={} uid0={} uid1={}]", sPartyIndex, pParty->uid[0], pParty->uid[1]);
}
