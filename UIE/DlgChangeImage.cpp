...
CDlgChangeImage::CDlgChangeImage(CWnd *pParent /*=nullptr*/) : CDialog(CDlgChangeImage::IDD, pParent)
{
...
void CDlgChangeImage::OnBBrowseOldFile()
{
    ...
    CFileDialog dlg(
        TRUE, "dxt", nullptr, dwFlags, "Generic Image Files(*.dxt, *.bmp, *.tga)|*.dxt;*.bmp;*.tga;||", nullptr);
