...
CDlgEditPartBillBoard::CDlgEditPartBillBoard(CWnd *pParent /*=nullptr*/) : CDialog(CDlgEditPartBillBoard::IDD, pParent)
{
...
void CDlgEditPartBillBoard::OnPartBoardBtnLoadTex()
{
    ...
    CFileDialog dlg(
        TRUE, nullptr, nullptr, dwFlags, "TGA (*.tga),BMP (*.bmp), DXT (*.dxt) |*.tga;*.bmp;*.dxt||", nullptr);
