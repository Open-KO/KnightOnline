...
bool CUILogIn_1298::Load(File &file)
{
    ...
    if (m_pGroup_Notice_1 != nullptr)
    {
        ...
        N3_VERIFY_UI_COMPONENT(
            m_pText_Notice1_Name_1, m_pGroup_Notice_1->GetChildByID<CN3UIString>("text_notice_name_01"));
    ...
    if (m_pGroup_Notice_2 != nullptr)
    {
        ...
        N3_VERIFY_UI_COMPONENT(
            m_pText_Notice2_Name_1, m_pGroup_Notice_2->GetChildByID<CN3UIString>("text_notice_name_01"));
        N3_VERIFY_UI_COMPONENT(m_pText_Notice2_Text_1, m_pGroup_Notice_2->GetChildByID<CN3UIString>("text_notice_01"));
        N3_VERIFY_UI_COMPONENT(
            m_pText_Notice2_Name_2, m_pGroup_Notice_2->GetChildByID<CN3UIString>("text_notice_name_02"));
    ...
    if (m_pGroup_Notice_3 != nullptr)
    {
        ...
        N3_VERIFY_UI_COMPONENT(
            m_pText_Notice3_Name_1, m_pGroup_Notice_3->GetChildByID<CN3UIString>("text_notice_name_01"));
        N3_VERIFY_UI_COMPONENT(m_pText_Notice3_Text_1, m_pGroup_Notice_3->GetChildByID<CN3UIString>("text_notice_01"));
        N3_VERIFY_UI_COMPONENT(
            m_pText_Notice3_Name_2, m_pGroup_Notice_3->GetChildByID<CN3UIString>("text_notice_name_02"));
        N3_VERIFY_UI_COMPONENT(m_pText_Notice3_Text_2, m_pGroup_Notice_3->GetChildByID<CN3UIString>("text_notice_02"));
        N3_VERIFY_UI_COMPONENT(
            m_pText_Notice3_Name_3, m_pGroup_Notice_3->GetChildByID<CN3UIString>("text_notice_name_03"));
