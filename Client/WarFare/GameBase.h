...
#define ACT_WORLD s_pWorldMgr->GetActiveWorld()
  ...
  public:
    ...
    static CN3TableBase<__TABLE_EXCHANGE_QUEST>
        s_pTbl_Exchange_Quest; // Old officially unused data for what were originally 'exchange quests'
  ...
  public:
    ...
    static e_ItemType MakeResrcFileNameForUPC(
