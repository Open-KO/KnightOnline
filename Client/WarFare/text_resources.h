...
enum e_TextResourceID
{
    ...
    IDS_NEWCHR_EL_MAGE = 3205, // The Magicians can become a Mage which uses 4 basic elements to perform attack magic or
                               // they can become an Enchanter, the master of mind control.
    IDS_NEWCHR_EL_MALE =
        3206, // El Moradian males have balanced Strength and Intelligence which makes them fit for any kind of job.
    IDS_NEWCHR_EL_PRIEST = 3207, // The Priests can become a Cleric to heal friends or become a Druid to cast a curse on
                                 // the enemy or increase ally's stats.
    IDS_NEWCHR_EL_ROGUE =
        3208, // The Rogues can become an Assassin to sneak up to the enemy and inflict a critical damage, or they can
              // become a Ranger that can attack enemies from far away with bows and spears.
    IDS_NEWCHR_EL_WARRIOR =
        3209, // The Warriors can become a Blade that uses variety of weapons to inflict critical damage, or they can
              // become a Protector with high defense ability to protect ally's magicians and priests.
    ...
    IDS_NEWCHR_KA_MAGE = 3212,      // The Magicians can become a Sorcerer which uses 4 basic elements to perform attack
                                    // magic or they can become a Necromancer, the master of the dead.
    IDS_NEWCHR_KA_PRIEST = 3213, // The Priests can become a Shaman that heals its ally or become a Dark Priest that can
                                 // use cursing skills.
    IDS_NEWCHR_KA_PURITUAREK = 3214, // 퓨리 투아렉은 순수하게 정화된 정신 에너지를 이용해 치료 마법과 저주 마법을
                                     // 구사하는 카루스의 여성 캐릭터로 법사와 사제의 직업을 선택할 수 있습니다.
    IDS_NEWCHR_KA_ROGUE =
        3215, // The Rogues can become an Assassin to sneak up to the enemy and inflict a critical damage, or they can
              // become a Hunter that can attack enemies from far away with bows and spears.
    IDS_NEWCHR_KA_TUAREK =
        3216, // Tuareks have balanced Strength and Intelligence which makes them fit for any kind of job.
    IDS_NEWCHR_KA_WARRIOR =
        3217, // The Warriors can become a Berserker that uses variety of weapons to inflict critical damage, or they
              // can become a Guardian with high defense ability to protect ally's magicians and priests.
    ...
    IDS_HELP_TIP24 = 5024, // Gaining Skill Points : You can gain 2 skill points every time you level up once you've
                           // reached level 10.
    IDS_HELP_TIP25 =
