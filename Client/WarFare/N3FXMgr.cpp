            ...
            if (dwToMe == 1 || dwToMe == 2)
            {
                ...
                if (dwToMe == 2 && ((pBundle->m_vPos - s_pPlayer->Position()).Magnitude() < 16.0f))
                {
                    ...
                    if (true == s_pPlayer->CheckCollisionByBox(
                                    ...
                                    &vCol,
                                    nullptr))
                    // if( true == CheckCollisionSphere(pBundle->m_vPos, pBundle->m_vPos +
                    // pBundle->m_vDir*pBundle->m_fVelocity*CN3Base::s_fSecPerFrm, vCp, s_pPlayer->Radius(), &vCol) )
                    {
                        bCol = true;
                        pBundle->m_vPos = vCol;
                        pBundle->Stop();
                ...
                for (; it != itEnd; it++)
                {
                    ...
                    // if( true == CheckCollisionSphere(pBundle->m_vPos, pBundle->m_vPos +
                    // pBundle->m_vDir*pBundle->m_fVelocity*CN3Base::s_fSecPerFrm, vCp, pUPC->Radius(), &vCol) )
                    if (true == pUPC->CheckCollisionByBox(
                                    pBundle->m_vPos,
                                    pBundle->m_vPos + pBundle->m_vDir * pBundle->m_fVelocity * CN3Base::s_fSecPerFrm,
                                    &vCol,
                                    nullptr))
                ...
                // Object 와 충돌 체크..
                if (bCol == false &&
                    true == ACT_WORLD->CheckCollisionWithShape(
