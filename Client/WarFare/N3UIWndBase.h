...
public:
	...
	virtual CN3UIArea*			GetChildAreaByiOrderPrefix(eUI_AREA_TYPE eUAT, int iOrder, const std::string& prefix /* = "" */);
	virtual CN3UIString*		GetChildStringByiOrder(int iOrder);
	virtual CN3UIString* GetChildStringByiOrderPrefix(int iOrder, const std::string& prefix /* = "" */);
