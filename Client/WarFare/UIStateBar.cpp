...
void CUIStateBar::UpdateHP(int iHP, int iHPMax, bool bUpdateImmediately)
{
    ...
    __ASSERT(
        iHP >= 0 && iHP < 10000 && iHPMax >= 0 && iHPMax < 10000, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
...
void CUIStateBar::TickMiniMap()
{
    ...
    mtxRot.PosSet(
        rc.left + minimapWidth2 + factorX * (m_vPosPlayer.x - m_vViewPos.x),
        rc.top + minimapHeight2 - factorY * (m_vPosPlayer.z - m_vViewPos.z),
        0);
