...
constexpr uint32_t SPECIAL_REQUIRED_ITEM_ID_MASTER_SCROLL_WARRIOR	= 379063000;
constexpr uint32_t SPECIAL_REQUIRED_ITEM_ID_MASTER_SCROLL_ROGUE		= 379064000;
constexpr uint32_t SPECIAL_REQUIRED_ITEM_ID_MASTER_SCROLL_MAGE		= 379065000;
constexpr uint32_t SPECIAL_REQUIRED_ITEM_ID_MASTER_SCROLL_PRIEST	= 379066000;

constexpr uint32_t SPECIAL_CONSUMED_ITEM_ID_STONE_OF_WARRIOR		= 379059000;
constexpr uint32_t SPECIAL_CONSUMED_ITEM_ID_STONE_OF_ROGUE		= 379060000;
constexpr uint32_t SPECIAL_CONSUMED_ITEM_ID_STONE_OF_MAGE		= 379061000;
constexpr uint32_t SPECIAL_CONSUMED_ITEM_ID_STONE_OF_PRIEST		= 379062000;
