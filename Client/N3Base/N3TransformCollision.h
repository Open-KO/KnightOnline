...
class CN3TransformCollision : public CN3Transform
{
  ...
  public:
    ...
    void SetMin(__Vector3 vMin)
    {
        m_vMin = vMin;
    }
    void SetMax(__Vector3 vMax)
    {
        m_vMin = vMax;
    }
    ...
    bool IsInRadius(__Vector3 &vCheckPos)
    {
        return ((vCheckPos - m_vPos).Magnitude() > m_fRadius ? FALSE : TRUE);
    }
    ...
    virtual int CheckCollisionPrecisely(
        bool bIgnoreBoxCheck, int ixScreen, int iyScreen, __Vector3 *pVCol = nullptr, __Vector3 *pVNormal = nullptr);
    //	BOOL CheckClimb(int x, int y, __Vector3* pVCol = nullptr, __Vector3* pVNormal = nullptr, __Vector3* pVPolygon =
    //nullptr); 	BOOL CheckClimb(__Vector3 &vPos, __Vector3 &vDir, __Vector3* pVCol = nullptr, __Vector3* pVNormal =
    //nullptr, __Vector3* pVPolygon = nullptr);
