...
void CN3Cloud::Render()
{
    ...
    static uint16_t CloudIndex[30] = {0, 1, 4, 1, 2, 5, 2, 3, 6, 3, 0, 7, 5, 4, 1,
    ...
    s_lpD3DDev->DrawIndexedPrimitiveUP(
        D3DPT_TRIANGLELIST, 0, 8, 10, CloudIndex, D3DFMT_INDEX16, m_pVertices, sizeof(__VertexXyzColorT2));
...
void CN3Cloud::Init(const std::string *pszFNs)
{
    ...
    /*	const float fSqrt3 = 1.0f/sqrtf(3.0f);
        ...
        float fTexUVLeft = 0.0f, fTexUVTop = 0.0f, fTexUVRight = 3.0f, fTexUVBottom = 3.0f;	// 텍스쳐 구름으로 표시할
    영역 좌표(텍스쳐의 전체가 될수도 있고 일부분이 될 수도 있기 때문에)
    ...
    //	const float fTexOffsetV_S = ((fBig+fMedium)/fTotal)*(fTexUVBottom-fTexUVTop)/2;
        ...
        // big
        m_pVertices[0].Set(-fBigLenth, fBigHeight,-fBigLenth, BigColor, fTexUVLeft,	fTexUVTop,		fTexUVLeft,
    fTexUVTop); m_pVertices[1].Set( fBigLenth, fBigHeight,-fBigLenth, BigColor, fTexUVRight,	fTexUVTop,
    fTexUVRight,	fTexUVTop); m_pVertices[2].Set( fBigLenth, fBigHeight, fBigLenth, BigColor, fTexUVRight,
    fTexUVBottom,	fTexUVRight,	fTexUVBottom); m_pVertices[3].Set(-fBigLenth, fBigHeight, fBigLenth, BigColor,
    fTexUVLeft,	fTexUVBottom,	fTexUVLeft,		fTexUVBottom);
        // medium
        m_pVertices[4].Set(-fMediumLength, fMediumHeight,-fMediumLength, MediumColor, fTexUVLeft+fTexOffsetU_M,
    fTexUVTop+fTexOffsetV_M,		fTexUVLeft+fTexOffsetU_M,	fTexUVTop+fTexOffsetV_M); m_pVertices[5].Set(
    fMediumLength, fMediumHeight,-fMediumLength, MediumColor, fTexUVRight-fTexOffsetU_M, fTexUVTop+fTexOffsetV_M,
    fTexUVRight-fTexOffsetU_M, fTexUVTop+fTexOffsetV_M); m_pVertices[6].Set( fMediumLength, fMediumHeight,
    fMediumLength, MediumColor, fTexUVRight-fTexOffsetU_M, fTexUVBottom-fTexOffsetV_M,	fTexUVRight-fTexOffsetU_M,
    fTexUVBottom-fTexOffsetV_M); m_pVertices[7].Set(-fMediumLength, fMediumHeight, fMediumLength, MediumColor,
    fTexUVLeft+fTexOffsetU_M,	fTexUVBottom-fTexOffsetV_M,	fTexUVLeft+fTexOffsetU_M,	fTexUVBottom-fTexOffsetV_M);

        // small
        m_pVertices[8].Set( -fSmallLength, fSmallHeight,-fSmallLength, SmallColor, fTexUVLeft+fTexOffsetU_S,
    fTexUVTop+fTexOffsetV_S,		fTexUVLeft+fTexOffsetU_S,	fTexUVTop+fTexOffsetV_S); m_pVertices[9].Set(
    fSmallLength, fSmallHeight,-fSmallLength, SmallColor, fTexUVRight-fTexOffsetU_S, fTexUVTop+fTexOffsetV_S,
    fTexUVRight-fTexOffsetU_S, fTexUVTop+fTexOffsetV_S); m_pVertices[10].Set( fSmallLength, fSmallHeight, fSmallLength,
    SmallColor, fTexUVRight-fTexOffsetU_S, fTexUVBottom-fTexOffsetV_S,	fTexUVRight-fTexOffsetU_S,
    fTexUVBottom-fTexOffsetV_S); m_pVertices[11].Set(-fSmallLength, fSmallHeight, fSmallLength, SmallColor,
    fTexUVLeft+fTexOffsetU_S,	fTexUVBottom-fTexOffsetV_S,	fTexUVLeft+fTexOffsetU_S,	fTexUVBottom-fTexOffsetV_S);
    */
    // 2단일때
    const float fSqrt3 = 1.0f / sqrtf(3.0f);
    ...
    m_pVertices[2].Set(
        fBigLenth, fBigHeight, fBigLenth, BigColor, fTexUVRight, fTexUVBottom, fTexUVRight, fTexUVBottom);
    ...
    m_pVertices[4].Set(
        ...
        -fSmallLength,
        SmallColor,
        fTexUVLeft + fTexOffsetU,
        fTexUVTop + fTexOffsetV,
        fTexUVLeft + fTexOffsetU,
        fTexUVTop + fTexOffsetV);
    m_pVertices[5].Set(
        fSmallLength,
