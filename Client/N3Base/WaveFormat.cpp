    ...
    ALsizei *pcmDataSize)
{
    ...
    if (riffHeader->FileTypeID[0] != 'R' || riffHeader->FileTypeID[1] != 'I' || riffHeader->FileTypeID[2] != 'F' ||
        riffHeader->FileTypeID[3] != 'F' || riffHeader->FileFormatID[0] != 'W' || riffHeader->FileFormatID[1] != 'A' ||
