...
struct __VertexT2 : public __VertexT1
{
  ...
  public:
    ...
    void Set(
        float sx, float sy, float sz, float snx, float sny, float snz, float stu, float stv, float stu2, float stv2)
    {
        x = sx;
        y = sy;
        z = sz;
...
struct __VertexTransformedT2 : public __VertexTransformed
{
  ...
  public:
    ...
    __VertexTransformedT2(
        float sx, float sy, float sz, float srhw, D3DCOLOR sColor, float stu, float stv, float stu2, float stv2)
    {
