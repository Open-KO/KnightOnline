...
void CN3FXSPart::Render()
{
    ...
    if (m_Mtl.nRenderFlags & RF_ALPHABLENDING) // Alpha 사용
    {
        ...
        if (pAP)
        {
            ...
            // pAP->nRenderFlags		= RF_ALPHABLENDING | RF_NOTUSEFOG | RF_DIFFUSEALPHA | RF_NOTUSELIGHT |
            // RF_DOUBLESIDED;
    ...
    uint32_t dwDoubleSide)
{
    ...
    uint32_t dwRenderFlag = RF_ALPHABLENDING | RF_NOTUSEFOG | RF_DIFFUSEALPHA | RF_NOTUSELIGHT | RF_DOUBLESIDED |
