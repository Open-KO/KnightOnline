...
template <eUI_TYPE... UITypes> static CN3UIBase *GetChildByIDImpl(const CN3UIBase *parent, const std::string_view szID)
{
    if (szID.empty())
        return nullptr;
...
#define IMPL_GETCHILDBYID(Class, MainUIType, ...)                                                                      \
    template <> Class *CN3UIBase::GetChildByID<Class>(const std::string_view szID) const                               \
    {                                                                                                                  \
