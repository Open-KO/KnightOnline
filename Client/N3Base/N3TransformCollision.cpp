...
/*
#ifdef _N3TOOL
BOOL CN3TransformCollision::CheckClimb(__Vector3 &vPos, __Vector3 &vDir, __Vector3* pVCol, __Vector3* pVNormal,
__Vector3* pVPolygon)
{
...
BOOL CN3TransformCollision::CheckClimb(int x, int y, __Vector3* pVCol, __Vector3* pVNormal, __Vector3* pVPolygon)
{
    ...
    vTmp.y = -( ( ( 2.0f * y ) / (CN3Base::s_CameraData.vp.Height) ) - 1 ) /
CN3Base::s_CameraData.mtxProjection.m[1][1]; vTmp.z =  1.0f;
