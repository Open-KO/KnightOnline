...
class CN3Chr : public CN3TransformCollision
{
  ...
  public:
    ...
    bool IsAnimEnd(); // 한번 하고 멈추는 에니메이션 일경우 .. 끝났는지?? 혹은 한번하고 전의 동작으로 돌아가는
                      // 에니메이션일 경우 돌아갔는지?
...
inline bool CN3Chr::IsAnimEnd() // 한번 하고 멈추는 에니메이션 일경우 .. 끝났는지?? 혹은 한번하고 전의 동작으로 돌아가는
                                // 에니메이션일 경우 돌아갔는지?
{
