...
template <typename T> static bool IsValidIntegerInRange(CString &szNewText)
{
...
{
    CString errorMsg;
    errorMsg.Format(IDS_ERROR_ITEM_VALIDATION_FAILED, szNewText, m_pTblBase->GetFullColumnName(m_iSubItem));
