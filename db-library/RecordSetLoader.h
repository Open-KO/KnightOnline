...
template <typename ModelType_, typename BoundModelType_ = ModelType_> class Base
{
  public:
    ...
    inline void SetProcessFetchCallback(ProcessFetchCallbackType processFetchCallback)
    {
  ...
  protected:
    template <bool AllowEmptyTable> bool Load(bool fetchRowCount)
    {
