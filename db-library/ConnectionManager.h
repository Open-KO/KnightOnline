...
class ConnectionManager
{
  ...
  public:
    ...
    /// \brief Fetches an established pool connection using the code-generated dbType, or otherwise attempt to establish
    /// a new pool connection using the code-generated dbType if one is not available.
    /// \throws DatasourceConfigNotFoundException
    /// \throws nanodbc::database_error
    static std::shared_ptr<PoolConnection> CreatePoolConnection(modelUtil::DbType dbType, long timeout = -1) noexcept(
        false);
  ...
  protected:
    ...
    /// \brief fetch an established pool connection using the code-generated dbType, or otherwise attempt to establish a
    /// new pool connection using the code-generated dbType if one is not available.
    /// \throws DatasourceConfigNotFoundException
    /// \throws nanodbc::database_error
