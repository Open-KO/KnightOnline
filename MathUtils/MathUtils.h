...
bool _IntersectTriangle(
    const __Vector3 &vOrig, const __Vector3 &vDir, const __Vector3 &v0, const __Vector3 &v1, const __Vector3 &v2);
bool _CheckCollisionByBox(const __Vector3 &vOrig, const __Vector3 &vDir, const __Vector3 &vMin, const __Vector3 &vMax);
_POINT _Convert3D_To_2DCoordinate(
    const __Vector3 &vPos,
    const __Matrix44 &mtxView,
    const __Matrix44 &mtxProjection,
    int iViewportWidth,
    int iViewportHeight);
void _Convert2D_To_3DCoordinate(
    ...
    int iyScreen,
    const __Matrix44 &mtxView,
    const __Matrix44 &mtxPrj,
    int iViewportWidth,
    int iViewportHeight,
    __Vector3 &vPosResult,
